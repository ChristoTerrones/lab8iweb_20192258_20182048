...
--
DROP DATABASE IF EXISTS `lab6sw1`;
CREATE DATABASE  IF NOT EXISTS `lab6sw1`;
USE `lab6sw1`;
...
CREATE TABLE `cancion_favorita` (
  `idcancion_favorita` int NOT NULL AUTO_INCREMENT,
  `cancion_idcancion` int NOT NULL,
  PRIMARY KEY (`idcancion_favorita`,`cancion_idcancion`),
  KEY `fk_cancion_favorita_cancion1_idx` (`cancion_idcancion`),
  CONSTRAINT `fk_cancion_favorita_cancion1` FOREIGN KEY (`cancion_idcancion`) REFERENCES `cancion` (`idcancion`)
...
INSERT INTO `cancion_favorita` VALUES (9,8),(10,9),(12,11),(13,12);
...
CREATE TABLE `playlist` (
  `idplaylist` varchar(45) NOT NULL,
  `cancion_idcancion` int NOT NULL,
  PRIMARY KEY (`idplaylist`,`cancion_idcancion`),
  KEY `fk_playlist_cancion1_idx` (`cancion_idcancion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `playlist` VALUES ('pop',8),('Rockeras',12),('musica para olvidar la desclasificacion',13),('jazz',17),('Rockeras',21),('salsa',29),('salsa',30),('Rockeras',31),('Rockeras',33),('musica para aprobar propa',42),('musica para olvidar la desclasificacion',44),('regueton',50),('musica para aprobar propa',53),('musica para olvidar la desclasificacion',63);
...
-- Dump completed on 2022-06-14 19:38:58
